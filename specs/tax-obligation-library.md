...
5. Unsupported, needs-review, or coverage-gap obligations can be requested for coverage or handled with a user-provided deadline.
...
- `Coverage gap` entries remain visible and support actions to request DueDateHQ verification, add a user-provided deadline, or ignore/dismiss for now.
